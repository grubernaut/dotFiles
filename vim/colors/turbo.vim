...
hi Normal		guifg=yellow	guibg=#000040				ctermfg=yellow		
...
hi Search		guifg=#90fff0	guibg=#2050d0				ctermfg=white		cterm=underline
...
hi WildMenu		guifg=yellow	guibg=black				ctermfg=yellow			cterm=none
